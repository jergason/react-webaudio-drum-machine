  ...
  render: function() {
    ...
    if (!this.state.loaded) {
      ...
      React.DOM.div( {className:"loading"}, 
        React.DOM.p( {className:"loading"}, "Loading",React.DOM.span(null, "."),React.DOM.span(null, "."),React.DOM.span(null, ".")),
        React.DOM.img( {src:"/images/dancing_baby.gif"} )
      ));
    }
    ...
    return (
    React.DOM.div( {className:"drum-machine"}, 
      React.DOM.h1(null, "DOMSTEP"),
      React.DOM.button( {onClick:this.togglePause}, this.state.paused ? "Play" : "Pause"),
      beats
    ));
  }
});
...
},{"./beat":139,"./instrumentStore":141,"./loadBuffers":142,"./utils":144,"react":137}],139:[function(require,module,exports){
/** @jsx React.DOM */
var React = require('react');
...
var Beat = React.createClass({displayName: 'Beat',
...
},{"./instrument":140,"./instrumentStore":141,"./play":143,"./utils":144,"react":137}],140:[function(require,module,exports){
/** @jsx React.DOM */
var React = require('react');
var play = require('./play');


var Instrument = React.createClass({displayName: 'Instrument',
  ...
  render: function() {
    ...
    return React.DOM.article( {onClick:this.toggleInstrument, className:"instrument" + " " + markIfSelected})
  }
});

module.exports = Instrument;

},{"./play":143,"react":137}],141:[function(require,module,exports){
var utils = require('./utils');
var instrumentStore = {
  changed: function() {},
...
},{"q":2}],143:[function(require,module,exports){
